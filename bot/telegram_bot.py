...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "• Mini App: https://o7031570-alt.github.io/telegram-mini-app/\n\n"
        "👨‍💻 **Admin:** @o7031570",
        parse_mode='Markdown'
    )
...
def main():
    ...
    if not BOT_TOKEN:
        ...
        logger.info("Please set BOT_TOKEN in Railway Variables or .env file")
        return
    ...
    try:
        ...
        logger.info(f"✅ Bot configured for channel: @for_you_today (ID: {CHANNEL_ID})")
        ...
        logger.info("Check if BOT_TOKEN is correct and bot has proper permissions")
